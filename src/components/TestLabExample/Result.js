    ...
    <>
      ...
      <div className='lg:w-[calc(100%-312px)] w-full lg:ml-[12px] h-[calc(100vh-24px)] overflow-y-auto '>
        ...
        <div className='sm:mt-[35px] mt-[26px] md:ml-[70px] md:mr-[70px] xl:px-[48px] flex flex-col md:flex-row justify-between'>
          <div className='sm:mt-[40px] mt-[40px] xl:px-[50px] bg-[#1B1D20] sm:w-[98%] md:w-[49%] rounded-[16px] p-6 text-center'>
            <h1 className='sm:text-[16px] text-[16px] mb-[12px] font-bold text-white'>Score</h1>
            <p className=' text-[#707e69]  sm:text-[32px] text-[32px] font-bold tracking-[.15px] leading-[24px]'>100%</p>
          </div>
          <div className='sm:mt-[40px] mt-[40px] xl:px-[50px] bg-[#1B1D20] sm:w-[98%] md:w-[49%] rounded-[16px] flex flex-row justify-start p-6'>
        ...
        <div className='sm:mt-[35px] mt-[26px] md:mr-[118px] text-right'>
          <button className=' bg-[#B6F09C] h-12 py-2 px-6 rounded-lg text-[#0C1132] font-semibold items-center' onClick={() => navigate('/test-lab')}>Take another Test </button>
          <button className=' bg-[#000000] h-12 py-2 px-6 max-w-[120px] ml-4 rounded-lg text-white font-semibold items-center' onClick={() => navigate('/dashboard')}>I'm Done </button>
        </div>
